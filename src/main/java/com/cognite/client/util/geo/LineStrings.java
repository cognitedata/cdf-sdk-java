...
/**
 * Helper class for working with {@link LineString} objects.
 */
public class LineStrings {

    /**
     * Create a {@link LineString} object based on a set of geo {@link Point}s.
     *
     * @param points The set of Points representing the LineString.
     * @return The {@link LineString} representing the geo feature.
     */
    public static LineString of(Point... points) {
        return LineString.newBuilder()
    ...
    /**
     * Create a {@link LineString} object based on a list of point coordinates.
     *
     ...
     *
     * @param coordinates The coordinate pairs/triplets for the LineString.
     * @return The {@link LineString} representing the geo feature.
     */
    ...
    /**
     * Create a {@link LineString} object based on a set of coordinates.
     *
     ...
     *
     * @param coordinates The coordinate pairs for the LineString.
     * @return The {@link LineString} representing the geo feature.
     */
    public static LineString of(double... coordinates) throws Exception {
