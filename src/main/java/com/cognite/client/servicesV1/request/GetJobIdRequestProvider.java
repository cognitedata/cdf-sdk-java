 ...
 */
@AutoValue
public abstract class GetJobIdRequestProvider extends GenericRequestProvider{

    static Builder builder() {
        return new AutoValue_GetJobIdRequestProvider.Builder()
    ...
    public static GetJobIdRequestProvider of(String endpoint) {
        return GetJobIdRequestProvider.builder()
    ...
    public static abstract class Builder extends GenericRequestProvider.Builder<Builder> {
        public abstract GetJobIdRequestProvider build();
    }
}