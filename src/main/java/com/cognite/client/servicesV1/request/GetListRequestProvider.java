...
@AutoValue
public abstract class GetListRequestProvider extends GenericRequestProvider{

    public static Builder builder() {
        return new AutoValue_GetListRequestProvider.Builder()
    ...
    public GetListRequestProvider withRequest(Request parameters) {
    ...
    public static abstract class Builder extends GenericRequestProvider.Builder<Builder> {
        public abstract GetListRequestProvider build();
    }
}
