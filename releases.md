...
- `UploadQueue` for various resource types to optimize data upload to Cognite Data Fusion.
- `State store` for storing watermark progress states for data applications (extractors, data pipelines, etc.)
